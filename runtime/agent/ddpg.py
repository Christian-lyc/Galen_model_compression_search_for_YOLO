...
class DdpgAgentHparams:
    def __init__(self, **kwargs):
        self.tau = float(kwargs.pop("agent_tau", 0.001)) #if key in kwargs, then return value in kwargs, else return 0.001
...
class DdpgAgent:
    ...
    def __init__(self,
        ...
        self._hard_update(self.actor, self.actor_target) #direct load actor network
