...
class CompressionRatioParameter:
    ...
    @classmethod
    def with_reference(cls, reference: int, parameter_key: str, initial_ratio=0.0, #compress ratio
                       bounds=(0.0, 1.0)) -> 'CompressionRatioParameter': #indicate the sparsity percentage
...
class CompressionPolicy:
    ...
    #self._layers is searched policies for each layer
